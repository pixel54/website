...
class ContactSection extends Component {
    ...
    emailClient(){
        window.emailjs.init('user_XfMOQm6kygOYQRb1DdRqz')
    }
                        ...
                        <form name="contactForm" id="contactForm" method="post" action="" noValidate="noValidate">
                            <fieldset>
                                <div className="form-field">
                                    <input name="contactName" onChange={this.upDateValue.bind(this)} type="text" id="contactName" placeholder="Your Name" value={this.state.name} minLength="2" required="" aria-required="true"
